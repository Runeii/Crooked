...
function crooked_scripts_styles() {
    wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . '/assets/css/style-min.css', null, '0.3', 'all' );
    wp_register_script( 'main', get_template_directory_uri() . '/assets/js/scripts-min.js', null, '0.3', true);
